...
class OwnerCourseEditMixin(OwnerCourseMixin,OwnerEditMixin,PermissionRequiredMixin):
    fields = ['subject', 'title', 'slug', 'overview']
    success_url = reverse_lazy('manage_course_list')
    template_name = 'courses/manage/course/form.html'

class ManageCourseListView(OwnerCourseMixin, ListView, PermissionRequiredMixin):
   # model = Course
